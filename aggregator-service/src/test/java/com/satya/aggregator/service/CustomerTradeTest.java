package com.satya.aggregator.service;
...
public class CustomerTradeTest extends AbstractIntegrationTest {
  ...
  private WebTestClient.BodyContentSpec postTrade(
      TradeRequest tradeRequest, HttpStatus expectedStatus) {
    return this.client
        .post()
